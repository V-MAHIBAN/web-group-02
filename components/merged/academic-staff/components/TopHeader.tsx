    ...
    <header className="sticky top-0 z-40 bg-white border-b border-[#E2E8F0] h-16 px-4 sm:px-6 md:px-8 flex items-center justify-between shadow-sm">
      ...
      <div className="flex items-center gap-1 sm:gap-2 ml-2 flex-shrink-0">
        ...
        <button
          ...
          className="bg-[#BF0A30] hover:bg-[#D7263D] active:scale-95 text-white flex items-center gap-2 px-3.5 sm:px-4 py-2 rounded-lg font-semibold text-[14px] shadow-xs transition-all duration-150"
        >
        ...
        <div ref={userRef} className="relative">
          <img
            ...
            alt="User Avatar"
            className="w-8 h-8 rounded-full border border-[#E2E8F0] object-cover cursor-pointer hover:ring-2 hover:ring-[#1D4ED8]/40 transition-all"
          />
