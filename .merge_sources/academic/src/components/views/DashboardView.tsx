  ...
  return (
    <div className="max-w-7xl mx-auto w-full space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white p-6 rounded-xl border border-[#E2E8F0] shadow-xs flex flex-col justify-between hover:shadow-md transition-shadow">
          <div className="flex justify-between items-start mb-4">
            <div>
              <h3 className="text-[16px] font-semibold text-[#5B4040]">Total Students</h3>
              <p className="text-[14px] text-[#5B4040]/80 mt-0.5">Present / Enrolled</p>
            </div>
            <div className="p-2.5 bg-[#DCE1FF] text-[#001551] rounded-lg">
              <span className="material-symbols-outlined text-[24px]">school</span>
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-[44px] md:text-[48px] font-bold text-[#121C2A] tracking-tight leading-none">
              {metrics.totalPresent}
            </span>
            <span className="text-[20px] font-semibold text-[#5B4040]/70">
              / {metrics.totalEnrolled}
            </span>
          </div>
          <div className="mt-4 w-full bg-[#E6EEFF] rounded-full h-1.5 overflow-hidden">
            <div
        ...
        <div className="bg-white p-6 rounded-xl border border-[#E2E8F0] shadow-xs flex flex-col justify-between hover:shadow-md transition-shadow">
          <div className="flex justify-between items-start mb-4">
            <div>
              <h3 className="text-[16px] font-semibold text-[#5B4040]">Late Arrivals</h3>
              <p className="text-[14px] text-[#5B4040]/80 mt-0.5">Recorded today</p>
            </div>
            <div className="p-2.5 bg-[#DEE9FC] text-[#121C2A] rounded-lg">
          ...
          <div className="mt-4 flex items-center gap-1.5 text-[12px] font-semibold text-[#BA1A1A]">
        ...
        <div className="bg-[#FFDAD9] p-6 rounded-xl border border-[#FFDAD6] shadow-xs flex flex-col justify-between hover:shadow-md transition-shadow">
          <div className="flex justify-between items-start mb-4">
            <div>
              <h3 className="text-[16px] font-semibold text-[#400009]">Pending Alerts</h3>
              <p className="text-[14px] text-[#920021] mt-0.5">Requires attention</p>
            </div>
            <div className="p-2.5 bg-[#BF0A30] text-white rounded-lg shadow-xs">
              <span className="material-symbols-outlined text-[24px]">warning</span>
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-[44px] md:text-[48px] font-bold text-[#940021] tracking-tight leading-none">
              {metrics.pendingAlerts}
            </span>
          </div>
          <div className="mt-4 flex items-center gap-1 text-[12px] font-bold text-[#940021] uppercase tracking-wider">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
        ...
        <div className="md:col-span-8 bg-white rounded-xl border border-[#E2E8F0] shadow-xs flex flex-col">
          <div className="p-5 sm:px-6 border-b border-[#E2E8F0] flex justify-between items-center bg-white rounded-t-xl">
            <h3 className="text-[20px] font-bold text-[#121C2A]">Recent Activity</h3>
            <button
              onClick={onViewAllActivity}
              id="view-all-activity-btn"
              className="text-[13px] font-semibold text-[#1D4ED8] hover:underline cursor-pointer"
            >
              View All
            </button>
          </div>
