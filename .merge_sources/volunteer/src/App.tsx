...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#1F2937] flex flex-col antialiased selection:bg-[#BF0A30]/20 selection:text-[#BF0A30]">
      ...
      {/* Main Content Area */}
      <div className="md:pl-64 flex-1 flex flex-col min-h-screen pb-20 md:pb-12">
        {/* Sticky Top Header */}
        <TopNav
          activeTab={activeTab}
          onTabChange={setActiveTab}
