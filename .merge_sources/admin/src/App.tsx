...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-gray-900 font-['Geist',sans-serif] antialiased flex flex-col">
      {/* Side Navigation */}
      <SideNav
      ...
      {/* Main Content Area */}
      <main className="md:ml-[280px] mt-16 md:mt-[72px] flex-1 p-4 sm:p-6 lg:p-8 max-w-7xl w-full mx-auto transition-all">
